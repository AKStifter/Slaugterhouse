                ...
                switch (input.toLowerCase()) {
                    case "1":
                        animals.values().forEach(animal -> 
                            System.out.println("Animal: ID=" + animal.getId() + ", Species=" + animal.getSpecies() + ", Weight=" + animal.getWeight()+ ", Origin=" + animal.getOrigin()+ ", Arrival date=" + animal.getArrivalDate()));
                        break;
                    case "2":
